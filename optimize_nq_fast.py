...
# Remove dead / useless strategies
results_df = results_df[results_df["entries"] >= 5].copy()

# Clean up infinite PF for sorting
...
print("\nTOP 15 NQ FAST RESULTS\n")
print(results_df.head(15).to_string(index=False))

results_df.to_csv("nq_fast_optimization_results.csv", index=False)
print("\nSaved nq_fast_optimization_results.csv")
